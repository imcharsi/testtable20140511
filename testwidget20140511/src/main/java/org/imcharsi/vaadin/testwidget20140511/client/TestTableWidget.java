...
import org.imcharsi.vaadin.testwidget20140511.client.TestTableWidget.VScrollTableBody;
import org.imcharsi.vaadin.testwidget20140511.client.TestTableWidget.VScrollTableBody.VScrollTableRow;
 ...
 */
public class TestTableWidget extends FlowPanel implements HasWidgets,
    ...
    public class HeaderCell extends Widget {
        ...
        private void setSorted(boolean sorted) {
            this.sorted = sorted;
            updateStyleNames(TestTableWidget.this.getStylePrimaryName());
        }
            ...
            if (enabled && event != null) {
                if (isResizing
                    ...
                    if (event.getTypeInt() == Event.ONCONTEXTMENU
                            && !client.hasEventListeners(TestTableWidget.this,
        ...
        private void createFloatingCopy() {
            ...
            String stylePrimaryName = TestTableWidget.this.getStylePrimaryName();
            StringBuilder sb = new StringBuilder();
            for (String s : TestTableWidget.this.getStyleName().split(" ")) {
        ...
        private void fireHeaderClickedEvent(Event event) {
            if (client.hasEventListeners(TestTableWidget.this,
                    TableConstants.HEADER_CLICK_EVENT_ID)) {
    ...
    public class TableHead extends Panel implements ActionOwner {
        ...
        private void focusSlot(int index) {
            ...
            if (index > 0) {
                ...
                child.setClassName(TestTableWidget.this.getStylePrimaryName()
                        + "-resizer");
                child.addClassName(TestTableWidget.this.getStylePrimaryName()
                        + "-focus-slot-right");
            } else {
        ...
        class VisibleColumnAction extends Action {
            ...
            public VisibleColumnAction(String colKey) {
                super(TestTableWidget.TableHead.this);
                this.colKey = colKey;
    ...
    public class VScrollTableBody extends Panel {
        ...
        private void detectExtrawidth() {
            ...
            if (rows.getLength() == 0) {
                ...
                VScrollTableRow scrollTableRow = new VScrollTableRow();
                scrollTableRow.updateStyleNames(TestTableWidget.this
                        .getStylePrimaryName());
                tBodyElement.appendChild(scrollTableRow.getElement());
                detectExtrawidth();
                tBodyElement.removeChild(scrollTableRow.getElement());
        ...
        public class VScrollTableRow extends Panel implements ActionOwner {
            ...
            protected void initCellWidths() {
                ...
                for (int i = 0; i < cells; i++) {
                    int w = TestTableWidget.this.getColWidth(getColKeyByIndex(i));
                    if (w < 0) {
                        w = 0;
                    }
                    setCellWidth(i, w);
            ...
            private void setIndex(int indexInWholeTable) {
                ...
                if (!isOdd) {
                    addStyleName(TestTableWidget.this.getStylePrimaryName()
                            + "-row-odd");
                } else {
                    addStyleName(TestTableWidget.this.getStylePrimaryName()
                            + "-row");
            ...
            protected void initCellWithText(String text, char align,
                ...
                container.setClassName(TestTableWidget.this.getStylePrimaryName()
                        + "-cell-wrapper");

                td.setClassName(TestTableWidget.this.getStylePrimaryName()
                        + "-cell-content");

                if (style != null && !style.equals("")) {
                    td.addClassName(TestTableWidget.this.getStylePrimaryName()
                            + "-cell-content-" + style);
                }
            ...
            protected void initCellWithWidget(Widget w, char align,
                ...
                final Element container = DOM.createDiv();
                String className = TestTableWidget.this.getStylePrimaryName()
                        + "-cell-content";
                if (style != null && !style.equals("")) {
                    className += " " + TestTableWidget.this.getStylePrimaryName()
                            + "-cell-content-" + style;
                }
                if (sorted) {
                    className += " " + TestTableWidget.this.getStylePrimaryName()
            ...
            protected void startRowDrag(Event event, final int type,
                ...
                transferable.setDragSource(ConnectorMap.get(client)
                        .getConnector(TestTableWidget.this));
        ...
        public void run() {
            ...
            if (isDynamicHeight() && totalRows == pageLength) {
                ...
                if (heightBefore != getOffsetHeight()) {
                    Util.notifyParentOfSizeChange(TestTableWidget.this, rendering);
                }
            }
            Scheduler.get().scheduleDeferred(new Command() {
    ...
    public class VScrollTableDropHandler extends VAbstractDropHandler {
        ...
        public ComponentConnector getConnector() {
            return ConnectorMap.get(client).getConnector(TestTableWidget.this);
        }
