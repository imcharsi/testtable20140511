...
import org.imcharsi.vaadin.testwidget20140511.client.TestTableWidget.ContextMenuDetails;
import org.imcharsi.vaadin.testwidget20140511.client.TestTableWidget.VScrollTableBody.VScrollTableRow;

import java.util.Iterator;

@Connect(TestTable.class)
public class TestTableConnector extends AbstractHasComponentsConnector implements
    ...
    @Override
    public TestTableWidget getWidget() {
        return (TestTableWidget) super.getWidget();
    }
    ...
    public void postLayout() {
        TestTableWidget table = getWidget();
        if (table.sizeNeedsInit) {
            ...
            Scheduler.get().scheduleFinally(new ScheduledCommand() {
                ...
                public void execute() {
                    ...
                    getLayoutManager().setNeedsMeasure(TestTableConnector.this);
